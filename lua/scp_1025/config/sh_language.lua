...
--]]
function scp_1025.GetTranslation(name)
    local langUsed = SCP_1025_CONFIG.LangServer
    if not SCP_1025_LANG[langUsed] then
        langUsed = "en" -- Default lang is EN.
    end
    return string.format( SCP_1025_LANG[langUsed][ name ] or "Not Found" )
end