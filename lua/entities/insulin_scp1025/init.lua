...
function ENT:Initialize()
	self:SetModel(SCP_1025_CONFIG.Models.Insulin)
	self:RebuildPhysics()
end
...
function ENT:Eat(ply)
	hook.Call("OnGlucideConsumption", nil, ply, SCP_1025_CONFIG.Settings.InsulinGlycemiaValue)
	ply:EmitSound(SCP_1025_CONFIG.Sounds.Injection, 75, math.random( 90, 110 ))
	self:Remove()
end
