...
function ENT:Initialize()
	self:SetModel(SCP_1025_CONFIG.Models.Inhalator)
	self:RebuildPhysics()
end
...
function ENT:Use(ply)
	...
	if (not ply.scp_1025_AsthmaCrisis) then return end

	ply.scp_1025_AsthmaCrisis = nil
	scp_1025.ClearBlurEffect(ply)
	ply:StopSound(SCP_1025_CONFIG.Sounds.AsthmaCrisis)
	timer.Remove("SCP1025.AsthmaCrisisPanic." .. ply:EntIndex())
	ply:EmitSound(SCP_1025_CONFIG.Sounds.InhalatorUsed, 75, math.random( 90, 110 ))
